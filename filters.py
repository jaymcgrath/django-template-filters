...
def add_attrs(value, arg):
    """
    custom template filter for packing extra html attrs onto django form fields, keeping views and forms free of front-end clutter
    arg should be formatted as "key:value, key1:value1, key2:value2" etc
    ...
    # Strip whitespace and add attribute pairs to dictionary
